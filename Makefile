##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.17.1] date: [Fri Sep 30 01:23:51 BRT 2022]
##########################################################################################################################
...
# Build path
BUILD_DIR = build
BSP_DISCO = Drivers/BSP
LEGRO_LIBS = LEGRO_LIBS
...
C_SOURCES =  \
Core/Src/main.c \
$(LEGRO_LIBS)/stm32f4xx_lg_encoder.c \
$(LEGRO_LIBS)/stm32f4xx_lg_dac.c \
Core/Src/gpio.c \
Core/Src/freertos.c \
Core/Src/dma.c \
Core/Src/usart.c \
...
$(BSP_DISCO)/stm32f429i_discovery.c \
$(BSP_DISCO)/stm32f429i_discovery_sdram.c \
$(BSP_DISCO)/stm32f429i_discovery_lcd.c \
$(BSP_DISCO)/Components/ili9341/ili9341.c \
...
-I$(BSP_DISCO) \
-I$(BSP_DISCO)/Components/ili9341   \
-I$(LEGRO_LIBS)  \
